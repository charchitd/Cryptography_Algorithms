...
Original file is located at
    https://colab.research.google.com/drive/1Lu7HSA7bmy5Pjb1_XKkpdx7W-iPoVp5e
"""
...
class AES:
    ...
    def encrypt(self, plaintext):
        ...
        self.shit_rows(self.plain_state)
    ...
    def decrypt(self, ciphertext):
        ...
        self.inv_shit_rows(self.cipher_state)
        self.sub_bytes(self.cipher_state)
    ...
    def round_decrypt(self, state_matrix, key_matrix):
        ...
        self.inv_shit_rows(state_matrix)
    ...
    def shit_rows(self, s):
        s[0][1], s[1][1], s[2][1], s[3][1] = s[1][1], s[2][1], s[3][1], s[0][1]
        s[0][2], s[1][2], s[2][2], s[3][2] = s[2][2], s[3][2], s[0][2], s[1][2]
        s[0][3], s[1][3], s[2][3], s[3][3] = s[3][3], s[0][3], s[1][3], s[2][3]


    def inv_shit_rows(self, s):
...
master_key=str(input(' Enter Master Key : '))   #2b7e151628aed2a6abf7158809cf4f3c
x=AES(int(master_key,16))
plain=str(input(' Enter Plain Text : '))  
cipher=hex(x.encrypt(int(plain,16)))         #3925841d02dc09fbdc118597196a0b32
